...
private void filterColumns(Table outData)  throws OException{
	...
	PluginLog.info("Filtering out non-stock rows from return table..");
	...
	for (int count = outData.getNumRows();count>=1 ;count--){
		...
		int intRowNum = tblLineDesc.unsortedFindString("description", balanceDesc,SEARCH_CASE_ENUM.CASE_INSENSITIVE);
