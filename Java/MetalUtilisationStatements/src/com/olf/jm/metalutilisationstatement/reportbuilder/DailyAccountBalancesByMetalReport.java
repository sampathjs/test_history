...
public class DailyAccountBalancesByMetalReport extends AbstractGenericScript {
    ...
    private Table runReportDateRange(Session session, Table parameters) throws ParseException {
        ...
        String vostroReportName = constants.getVostroAccountBalanceReport();
        String nostroReportName = constants.getNostroAccountBalanceReport();
