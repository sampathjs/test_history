...
public class LBMAReportOutput implements IScript
{
	...
	public void execute(IContainerContext context) throws OException
	{
		...
		try
		{
			...
			if (dataTable.getNumRows() > 0) {
				...
				//generatingOutputCsv(dataTable, paramTable, fullPath, "", 0);
	...
	private void validateData(Table tblData) throws OException {
		...
		if(tblExceptions.getNumRows() > 0){
			...
			mymessage.addSubject("WARNING | LBMA extract generated with validation errors.");
