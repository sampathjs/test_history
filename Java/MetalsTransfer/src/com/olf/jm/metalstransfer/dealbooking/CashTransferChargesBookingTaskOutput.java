...
/*
 * History:
 * 2018-03-15 - V0.1 - scurran - Initial Version
 */

/**
 * The Class CashTransferChargesBookingTaskOutput.
 * 
 * Output script to display a message box to the user to show that the task has completed
 * 
 */
@ScriptCategory({ EnumScriptCategory.Generic })
public class CashTransferChargesBookingTaskOutput extends AbstractGenericScript {

	/** The const repository used to initialise the logging classes. */
	private ConstRepository constRep;
	
	/** The Constant CONST_REPOSITORY_CONTEXT. */
	private static final String CONST_REPOSITORY_CONTEXT = "MetalsTransfer";
	
	/** The Constant CONST_REPOSITORY_SUBCONTEXT. */
	private static final String CONST_REPOSITORY_SUBCONTEXT = "ChargesBooking";
