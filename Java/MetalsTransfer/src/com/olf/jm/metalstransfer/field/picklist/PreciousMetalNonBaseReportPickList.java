...
public class PreciousMetalNonBaseReportPickList extends AbstractPickList {
    ...
    private ReferenceChoices process(Context context, ReferenceChoices choices) {
        try (Table metals = context.getIOFactory().runSQL(
                "SELECT id_number, name, description FROM currency WHERE id_number IN (53, 54, 55, 56) and precious_metal = 1")) {
