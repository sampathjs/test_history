...
public class Migr_RefData_Addresses implements IScript
{
    	...
    	//Define the variables used in the script
    	  ...
    	  //Constants Repository Statics
    	    ...
    	    for(int iaddress=1; iaddress<=rowCountAddress; iaddress++){
    	    	...
    	    	if(scheck.equalsIgnoreCase("Confirm to")|| scheck.equalsIgnoreCase("Invoice to")|| scheck.equalsIgnoreCase("Consignee"))
    	    	{
    	    	newLegalEntity.getTable("party_address", 1).insertRowAfter(0);
    	    	}
				...
				else
				{
					if(scheck.equalsIgnoreCase("Main")){
						newLegalEntity.getTable("party_address", 1).setInt("default_flag", 1, Ref.getValue(SHM_USR_TABLES_ENUM.NO_YES_TABLE,"YES"));
						if (AddressEndurfieldLE.equalsIgnoreCase("addr1")|| AddressEndurfieldLE.equalsIgnoreCase("addr2") || AddressEndurfieldLE.equalsIgnoreCase("city")|| AddressEndurfieldLE.equalsIgnoreCase("mail_code")|| AddressEndurfieldLE.equalsIgnoreCase("fax")|| AddressEndurfieldLE.equalsIgnoreCase("phone")) 
				    			{
				    				newLegalEntity.getTable("party_address", 1).setString(AddressEndurfieldLE, 1, retfieldAddressLE);//To update Party_Address Table inside Party Table
							...
							newLegalEntity.getTable("party_address", 1).setString(AddressEndurfieldLE, 1, retfieldAddressLE);
						}
				    				...
				    				newLegalEntity.getTable("party_address", 1).setInt(AddressEndurfieldLE, 1, Ref.getValue(SHM_USR_TABLES_ENUM.COUNTRY_TABLE,retfieldAddressLE));
				    				...
				    				newLegalEntity.getTable("party_address", 1).setInt(AddressEndurfieldLE, 1, Ref.getValue(SHM_USR_TABLES_ENUM.PS_COUNTY_TABLE,retfieldAddressLE));
				    					}
				    			/*else if (AddressEndurfieldLE.equalsIgnoreCase("linked_le_name"))
				    				...
				    				newLegalEntity.getTable("party_address", 1).setInt(AddressEndurfieldLE, 1, Ref.getValue(SHM_USR_TABLES_ENUM.PARTY_ADDRESS_TYPE_TABLE,retfieldAddressLE));
				    				}
				    				...
				    				newLegalEntity.getTable("party_address", 1).setInt(AddressEndurfieldLE, 1, Ref.getValue(SHM_USR_TABLES_ENUM.STATES_TABLE,retfieldAddressLE));
	    	...
	    	if(scheck.equalsIgnoreCase("Confirm to")|| scheck.equalsIgnoreCase("Invoice to")|| scheck.equalsIgnoreCase("Consignee")){
    	    	newBunit.getTable("party_address", 1).insertRowBefore(1);
    	    }
			...
			{	    	
			if(scheck.equalsIgnoreCase("Main")){
				newBunit.getTable("party_address", 1).setInt("default_flag", 1, Ref.getValue(SHM_USR_TABLES_ENUM.NO_YES_TABLE,"YES"));
			...
			{
				newBunit.getTable("party_address", 1).setString(AddressEndurfieldBU, 1, retfieldAddressBU);
			...
			else if(AddressEndurfieldBU.equalsIgnoreCase("addr_reference_name")|| AddressEndurfieldBU.equalsIgnoreCase("irs_terminal_num") )
			{
				...
				newBunit.getTable("party_address", 1).setInt(AddressEndurfieldBU, 1, Ref.getValue(SHM_USR_TABLES_ENUM.COUNTRY_TABLE,retfieldAddressBU));
				...
				newBunit.getTable("party_address", 1).setInt(AddressEndurfieldBU, 1, Ref.getValue(SHM_USR_TABLES_ENUM.PS_COUNTY_TABLE,retfieldAddressBU));
					}
			/*else if (AddressEndurfieldBU.equalsIgnoreCase("linked_le_name"))
				...
				newBunit.getTable("party_address", 1).setInt(AddressEndurfieldBU, 1, Ref.getValue(SHM_USR_TABLES_ENUM.PARTY_ADDRESS_TYPE_TABLE,retfieldAddressBU));
					}
				...
				newBunit.getTable("party_address", 1).setInt(AddressEndurfieldBU, 1, Ref.getValue(SHM_USR_TABLES_ENUM.STATES_TABLE,retfieldAddressBU));
		...
		newBunit.getTable("party_address", 1).setString(AddressEndurfieldBU, 1, retfieldAddressBU.toString());
			...
			try
         	...
         	if(simporttype.equalsIgnoreCase(lebu)){
				...
				temp=Ref.retrieveParty(Ref.getValue(SHM_USR_TABLES_ENUM.PARTY_TABLE,sparty));
         	int addrLE= temp.getTable("party_address",1).getInt("party_address_id",1);
         	String LEaddr= Integer.toString(addrLE);
         	user_migr_p_addr.setString("new_le_address_id", row, LEaddr);
         	}
         	
         	Table tempBU=Table.tableNew();
			tempBU=Ref.retrieveParty(Ref.getValue(SHM_USR_TABLES_ENUM.PARTY_TABLE,spartyBU));
			int addrBU= tempBU.getTable("party_address",1).getInt("party_address_id",1);
			String BUaddr= Integer.toString(addrBU);
         	user_migr_p_addr.setString("new_bu_address_id", row, BUaddr);
         	user_migr_p_addr.setString("status_flag", row, "BOOKED");
         	user_migr_p_addr.setString("target_status_flag",row , "BOOKED");
         	user_migr_p_addr.setInt("row_type",row , 6);	
         	user_migr_p_addr.setString("status_msg", row, "Successfully Booked");
	...
	private void errorupdate(int rownum, String msg, String select) throws OException{
		 ...
		 try
       	...
       	user_migr_p_addr.setTableName(select);
        	DBUserTable.load(user_migr_p_addr);
        	user_migr_p_addr.sortCol("row_id");
       	int row=user_migr_p_addr.findInt("row_id", rownum, SEARCH_ENUM.LAST_IN_GROUP);
