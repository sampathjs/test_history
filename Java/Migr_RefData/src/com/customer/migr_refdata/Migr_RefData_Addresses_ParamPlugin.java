...
public class Migr_RefData_Addresses_ParamPlugin implements IScript {
		...
		definitions.destroy();
				...
				private String getSql() {
					...
					sql = "select a.type_id as 'Definition Id', a.type_name  as 'Definition Name', b.data_type as 'Type', b.current_status  as 'Status', b.data_load_table as 'Table' " +
						"from  USER_csv_channel_type a, USER_migr_op_data_load b where a.type_id=b.type_id AND b.data_type='ADDRESS_DATA' ORDER BY b.type_id";
					return sql;
				}
