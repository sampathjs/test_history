...
public class Migr_RefData_Acct_SI implements IScript
{
    ...
    public void execute(IContainerContext context) throws OException
    {
		...
		//Accounts and Settle Instruction - Start looping through the data got from import table	  
	  	...
	  	for(int iAcct=1; iAcct<=rowCountAcct;iAcct++)//
	  	{
	  		...
	  		Table acct = Ref.retrieveAccount(0); //Retrieve Account Table
	  		String newpartyid= tAcct.getString("linked_bu_name", iAcct);
    	    	...
    	    	else
				{
	  			...
	  			catch (OException Error)
	  			{
	    	    	...
	    	    	int retval = Ref.addNewAccount(acct);
	    			...
	    			Table settle = Ref.retrieveSettleInstruction(0);//Retrieve Settle Instruction
					...
					{	      	    	    	    	
	      	    	...
	      	    	int retvalstl = Ref.addNewSettleInstruction(settle);
	  				...
	  				int newsettleid = settle.getInt("settle_id", 1);
		    			...
		    			String settleName= tempsettle.getString("settle_name", 1);
		    			 ...
		    			 try
		                 	...
		                 	user_migr_p_acct_si.setString("status_flag", row, "BOOKED");
		                 	user_migr_p_acct_si.setString("target_status_flag",row , "BOOKED");
		                 	user_migr_p_acct_si.setInt("row_type",row , 6);
		                 	user_migr_p_acct_si.setString("status_msg", row, "Successfully Booked");
