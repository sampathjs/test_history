...
/**
 * The Class SAPCounterpartyMapper. 
 */
public class SAPCounterpartyMapper extends FieldMapperBase {

	/** The source data. */
	private Table sourceData;
	
	/**
	 * Instantiates a new SAP counterparty mapper.
	 *
	 * @param context the context the script is running in
	 * @param currentSourceData the source data from the input message
	 */
	public SAPCounterpartyMapper(final Context context, final Table currentSourceData) {
		super(context);
	...
	public final String getValue() {
		return sourceData.getString(EnumSapCoverageRequest.COUNTER_PARTY_NAME.getColumnName(), 0);
	}
