 ...
 */
public class CoverageMetalElementValidator extends FieldValidatorBase {
	
	/** The Constant FIELD_ERROR_CODE. */
	private static final int FIELD_ERROR_CODE = 2002;
	 ...
	 */
	public CoverageMetalElementValidator(final Context currentContext) {
	...
	public final String getFieldName() {
		return EnumSapCoverageRequest.ELEMENT_CODE.getColumnName();
	}
