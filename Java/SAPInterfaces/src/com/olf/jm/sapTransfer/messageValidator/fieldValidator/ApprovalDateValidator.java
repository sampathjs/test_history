...
/**
 * The Class ApprovalDate. Validate the input message field ApprovalDate.
 */
public class ApprovalDateValidator extends FieldValidatorBase {
	
	/** The Constant FIELD_ERROR_CODE. */
	private static final int FIELD_ERROR_CODE = 3007;
	
	/** The Constant FIELD_ERROR_DESCRIPTION. */
	private static final String FIELD_ERROR_DESCRIPTION = "Approval date is Invalid";
