...
/**
 * The Class ChargesInUsdMapper.
 */
public class ChargesInUsdMapper extends FieldMapperBase {
	 ...
	 */
	public ChargesInUsdMapper(final Context context) {
		super(context);
	}
	...
	protected final String getInfoFieldName() {
		return EnumStrategyInfoFields.CHARGE_IN_USD.getFieldName(); 
	}
