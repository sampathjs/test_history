...
/**
 * The Class ChargesMapper.
 */
public class ChargesMapper extends FieldMapperBase {
	 ...
	 */
	public ChargesMapper(final Context context) {
		super(context);
	}
	...
	protected final String getInfoFieldName() {
		return EnumStrategyInfoFields.CHARGES.getFieldName(); 
	}
