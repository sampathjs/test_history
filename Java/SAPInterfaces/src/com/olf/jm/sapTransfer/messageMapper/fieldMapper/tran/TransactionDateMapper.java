...
/**
 * The Class TransactionDateMapper. Mapping logic to populate the
 * transaction date info field.
 */
public class TransactionDateMapper extends FieldMapperBase {

	/** The source data. */
	private Table sourceData;
	
	/**
	 * Instantiates a new transaction date mapper.
	 *
	 * @param context the context
	 * @param currentSourceData the source data
	 */
	public TransactionDateMapper(final Context context, final Table currentSourceData) {
		super(context);
