...
public class STD_SavedQueryParam implements IScript {

	private JVS_INC_Standard m_INCStandard;

	public STD_SavedQueryParam(){
	...
	public void execute(IContainerContext context) throws OException
	{
		...
		String error_log_file = Util.errorInitScriptErrorLog(Util.getEnv("AB_OUTDIR") + "\\error_logs\\" + "STD_SavedQueryParam");
