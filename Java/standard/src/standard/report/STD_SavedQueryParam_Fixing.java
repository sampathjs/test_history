...
public class STD_SavedQueryParam_Fixing implements IScript {

	private JVS_INC_Standard m_INCStandard;

	public STD_SavedQueryParam_Fixing(){
	...
	public void execute(IContainerContext context) throws OException
	{
		...
		String query_name = "AllPortfolios_Fixing";
		/*********************************************************************/
		int accessGui = Util.canAccessGui();
		int query_id, i, numRows, run_id = 0;

		String error_log_file = Util.errorInitScriptErrorLog(Util.getEnv("AB_OUTDIR") + "\\error_logs\\" + "STD_SavedQueryParam_Fixing");
