...
/*
File Name:                      JM_MTM_Batch_Simulation_Param.java

Report Name:                    

Output File Name:               JM_MTM_Batch_Simulation_Param.log
...
public class JM_MTM_Batch_Simulation_Param implements IScript {
	
	private JVS_INC_Standard m_INCStandard;
	public JM_MTM_Batch_Simulation_Param(){
	...
	public void execute(IContainerContext context) throws OException
	{
		...
		String batch_sim_name = "EOD MTM All Portfolios";
		...
		String sFileName = "JM_MTM_Batch_Simulation_Param";
