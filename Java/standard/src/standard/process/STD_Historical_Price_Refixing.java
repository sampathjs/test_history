/*$Header: /cvs/master/olf/plugins/standard/process/STD_Historical_Price_Refixing.java,v 1.8 2013/02/19 14:29:42 chrish Exp $*/
/**************************************************************************************************
Script File Name:    STD_Historical_Price_Refixing.java
...
Revision History:    08/07/07 bsowers   Initial check-in
                     ...
                     10/13/10 adelacruz Replaced Util.exitFail with throwing an OException


Parameter Script:    STD_Historical_Price_Refixing_P.java (optional)
...
Description:         This plugin is used to udpate the fixings after historical prices are
                     changed in the system. The plugin can take a list of indexes
                     from a parameter plugin or it can be used without a paramter
                     plugin.  If a list of indexes is not passed in, it will use all 
                     indexes that have saved historical prices.  A report is generated showing 
                     what deals have changed.

Assumptions:         Expects argt to have the following structure:
                      - index_id_list  COL_TYPE_ENUM.COL_TABLE
