 ...
 * @author jwaechter
 * @version 1.1
 * @see {@link CreateHoldingInstrumentsParam}
 */
@ScriptCategory( { EnumScriptCategory.Generic })
public class CreateHoldingInstrumentsMain extends AbstractGenericScript {	
	...
	private Table getLatestHoldingIns() {
		int indexDbStatusValidated = sdf.getId(EnumReferenceTable.IdxDbStatus, CreateHoldingInstrumentsParam.INDEX_DB_STATUS_VALIDATED);
