...
/*
File Name:                      PhysicalVolumesByPricingDates.java
...
public class APM_PhysVolumesNAGas implements IScript
{
	@Override
         ...
         throws OException 
   {
      ...
      if (ParamHasValue(tblConfig, "APM Phys Volume Mass Unit") > 0)
      {
    	  strVal = GetParamStrValue(tblConfig, "APM Phys Volume Mass Unit");
    	  if (!strVal.isEmpty())
    	  {
      ...
      if (ParamHasValue(tblConfig, "APM Phys Volume Volume Unit") > 0)
      {
    	  strVal = GetParamStrValue(tblConfig, "APM Phys Volume Volume Unit");
       	  if (!strVal.isEmpty())
    	  {
      ...
      if (ParamHasValue(tblConfig, "APM Phys Volume Energy Unit") > 0)
      {
    	  strVal = GetParamStrValue(tblConfig, "APM Phys Volume Energy Unit");
    	  if (!strVal.isEmpty())
    	  {
      ...
      if (ParamHasValue(tblConfig, "APM Phys Volume Show All Volume Statuses") > 0)
      {
    	  showAllVolumeStatuses = GetParamIntValue(tblConfig, "APM Phys Volume Show All Volume Statuses");      
      }      

      if (ParamHasValue(tblConfig, "APM Phys Volume Split By Day") > 0)
      {
    	  splitByDay = GetParamIntValue(tblConfig, "APM Phys Volume Split By Day");      
      }      

      if (ParamHasValue(tblConfig, "APM Phys Volume Natural Startpoint") > 0)
      {
    	  startPoint = GetParamDateValue(tblConfig, "APM Phys Volume Natural Startpoint");      
      }      

      if (ParamHasValue(tblConfig, "APM Phys Volume Natural Endpoint") > 0)
      {
    	  endPoint = GetParamDateValue(tblConfig, "APM Phys Volume Natural Endpoint");      
      }      

      if (ParamHasValue(tblConfig, "APM Phys Volume Volume Types") > 0)
      {
    	  volumeTypesStr = GetParamStrValue(tblConfig, "APM Phys Volume Volume Types");      
      }      
   ...
   int GetParamIntValue(Table tResConfig, String sParamName) throws OException
   {
      int iRow, iVal;
   ...
   String GetParamStrValue(Table tResConfig, String sParamName) throws OException
   {
      int iRow;
      String sVal;
   ...
   int ParamHasValue(Table tResConfig, String sParamName)  throws OException
   {
      int iRow;
      String sValue;
