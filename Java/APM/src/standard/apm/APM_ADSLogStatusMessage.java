...
public class APM_ADSLogStatusMessage implements IScript {
	...
	///
	public void execute(Table argt) throws OException {
		...
		retVal = ADS_LogStatusMessage(messageType, packageName, entityGroupId, scenarioId, datasetTypeId, serviceId, secondaryEntityNum, primaryEntityNum, primaryEntityName, entityGroupIdName, message);
	 ...
	 * @throws OException
	 */
	public int ADS_LogStatusMessage(int iMsgType, String packageName, int entityGroupId, int scenarioId, int datasetTypeId, int serviceId, int secondaryEntityNum, int primaryEntityNum, String primaryEntityName, String entityGroupIdName, String message) throws OException {
		...
		try {
		   ...
		   try {
		      if (iMsgType == cStatusMsgTypeCompleted) {
		         ...
		         adsLogging.removeBadUpdate(packageName, entityGroupId, scenarioId, datasetTypeId, serviceId, primaryEntityNum, entityGroupIdName);
