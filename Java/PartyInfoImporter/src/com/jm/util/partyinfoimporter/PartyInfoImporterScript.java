...
public class PartyInfoImporterScript implements IScript
{
    ...
    private void updatePartyInfoFields(Table outtable, Set<Integer> toRetain) throws OException {
    	...
    	updatePartyInfoField (outtable, "DIVIS PHARMACEUTICAL - BU", "Customer Code USD", "41769", toRetain);
    	...
    	//updatePartyInfoField (outtable, "CRI-CRITERION CATALYST CO - BU", "Customer Code GBP", "33523", toRetain);
