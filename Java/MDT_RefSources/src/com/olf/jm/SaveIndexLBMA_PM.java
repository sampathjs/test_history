...
public class SaveIndexLBMA_PM implements IScript {

	public void execute(IContainerContext context) throws OException
	{
		setUpLog();
		
		PluginLog.debug("START SaveIndexLBMA_PM");
		...
		try
		{
			...
			tblArgt.setString("ref_src", intRowNum, "LBMA PM");
		...
		PluginLog.debug("END SaveIndexLBMA_PM");
