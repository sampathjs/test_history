...
public class MDTLoaderBFIX1400 implements IScript {
	...
	public void execute(IContainerContext context) throws OException
	{
		...
		Logging.debug("START MDTLoaderBFIX1400 param");
		
			
		Logging.info("Importing prices for BFIX 1400 on " + OCalendar.formatJd(OCalendar.today()));
		...
		Logging.debug("END MDTLoaderBFIX1400 param");
		Logging.close();
