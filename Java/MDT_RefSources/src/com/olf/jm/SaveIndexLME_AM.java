...
public class SaveIndexLME_AM implements IScript {

	public void execute(IContainerContext context) throws OException
	{
		setUpLog();
		
		PluginLog.debug("START SaveIndexLMEAM");
		...
		try
		{
			...
			tblArgt.setString("ref_src", intRowNum, "LME AM");
		...
		PluginLog.debug("END SaveIndexLMEAM");
