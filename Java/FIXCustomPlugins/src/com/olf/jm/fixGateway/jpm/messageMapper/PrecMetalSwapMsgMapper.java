...
/**
 * Message mapper to convert a JPM Execute fix message containing a precious metal FX forward deal into a
 * TradeBuilder table. 
 */
public class PrecMetalSwapMsgMapper implements MessageMapper, AutoCloseable {
	 ...
	 */
	public PrecMetalSwapMsgMapper(Table fixMessage) throws MessageMapperException{
