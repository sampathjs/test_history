...
/**
 * Class responsible for mapping the unit.
 */
public class BaseMetalUnit extends FieldMapperBase {
	/* (non-Javadoc)
	 * @see com.olf.jm.fixGateway.fieldMapper.FieldMapperBase#getTranFieldName()
	 */
	@Override
	public TRANF_FIELD getTranFieldName() {
		return TRANF_FIELD.TRANF_UNIT;
	}
	...
	public String getTagFieldName() {
		return EnumExecutionReport.TAG_996.getTagName();
	}
}
