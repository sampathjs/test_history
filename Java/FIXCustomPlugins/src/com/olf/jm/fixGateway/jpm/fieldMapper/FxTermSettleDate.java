...
/**
 * Class responsible for mapping the FX Term Settle Date.
 */
public class FxTermSettleDate extends FieldMapperBase {
	...
	public TRANF_FIELD getTranFieldName() {
		...
		return TRANF_FIELD.TRANF_FX_TERM_SETTLE_DATE;
	}
