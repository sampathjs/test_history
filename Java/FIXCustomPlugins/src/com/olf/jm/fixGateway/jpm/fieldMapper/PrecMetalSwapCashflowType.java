...
/**
 *  Class responsible for providing the cash flow type for precious metal FX swap deals that is hard coded 
 *  to FX Swap
 *  
 */
public class PrecMetalSwapCashflowType extends FieldMapperBase {
	/* (non-Javadoc)
