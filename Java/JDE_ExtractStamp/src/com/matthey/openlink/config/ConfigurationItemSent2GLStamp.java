...
public enum ConfigurationItemSent2GLStamp implements IConstRepItem {
	...
	public static final String CONST_REP_SUBCONTEXT="Sent2GLStamp";
	...
	private ConfigurationItemSent2GLStamp (final String value) {
		this.value = value;
		this.constRepVarName = null;
		this.defaultValue = null;
	}
	
	private ConfigurationItemSent2GLStamp (final String constRepVarName, final String defaultValue) {
