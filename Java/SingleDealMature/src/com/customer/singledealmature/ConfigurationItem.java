...
public enum ConfigurationItem implements ConstRepItem {
	...
	LOG_DIR ("logDir", ""),
	LOG_FILE ("logFile", ""),
	DEAL_TRACKING_NUM ("dealTrackingNum", "")
	;

	public static final String CONST_REP_CONTEXT="Util";
	public static final String CONST_REP_SUBCONTEXT="SingleDealMature";
	...
	public String asString() {
		return CONST_REP_CONTEXT + "\\" + CONST_REP_SUBCONTEXT + "\\" + constRepVarName + "=" + getValue(); 
	}
}
