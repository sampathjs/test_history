	...
	public PreProcessResult preProcess(Context context,
		...
		//if (permissableStatus.contains(targetStatus)) 
		  for (PreProcessingInfo<?> activeItem : infoArray) {
	            ...
	            try {
				Logging.init(context, this.getClass(), "DispatchInfoStamping", "");
				Logging.info("Started DispatchInfoStamping pre process");
				...
				Logging.info("Completed DispatchInfoStamping pre process");
				Logging.close();
			}
		  }
