...
public class PartyInfoUpdaterParam extends AbstractGenericScript {
	...
	private void createGUI(Context context, final Display display, Table partyList, Table partyInfoFields, final Table returnt) {
		...
		addListeners(context, display, returnt, frame, this.extBUList, partyInfoList, label3, label4, fieldValueList, button);
		
		addComponents(label1, label2, label3, label4, this.extBUList, partyInfoList, fieldValueList, button, frame.getContentPane());
        frame.pack();
	...
	private void addListeners(final Context context, final Display display, final Table returnt, final JFrame frame,
			...
			JLabel labelText, final JComboBox<String> fieldValueList, JButton button) {
		...
		partyInfoList.addItemListener(new ItemListener() {
			...
			public void itemStateChanged(ItemEvent event) {
			    	...
			    	if(infoFieldValues != null && infoFieldValues.getRowCount() > 0)
			    	{
						...
						fieldValLabel.setVisible(false);
						fieldValueList.setVisible(false);
	...
	private void addComponents(JLabel label1, JLabel label2, JLabel label3, JLabel label4, final JList<String> extBUList,
