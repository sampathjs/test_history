...
/*
 * History:
 * 2016-03-21	V1.0	jwaechter	- created as copy of "MigrOpsSetSi"
 *                                  - removed check if provided SIs match core criteria
 * 2016-04-04	V1.1	jwaechter	- added fix to handle case with transaction does not have a certain combination
 *                                    of ccy, party, delivery type and int/ext
 * 2016-04-08	V1.2	jwaechter	- added flip of internal / external for offset transactions
 *                                  - added possibilty to select the first SI of the SIs allowed by
 *                                    core
 * 2016-04-09	V1.3	jwaechter	- removed throwing exception if no row in the SI table is found
...
public class MigrOpsSetSiWithoutCheck extends AbstractTradeProcessListener {
	...
	private void setSiFromMigrationData(Session session, Transaction tran,
			MigrSettlementInstruction migrSi, boolean flipIntExt, String settlementInstructionName) {
