...
/*
 * History:
 * 2018-11-25		V1.0	jwaechter		- Initial Version
 */
 ...
 * @version 1.0
 */
public class IntegerLessThanOrEquals extends AbstractPredicate<Integer>{
	private double threshold;
	
	public IntegerLessThanOrEquals(String unparsedPredicate,
			int weight) {
	...
	private int parseIntegerPredicate(String unparsedPredicate) {
		...
		String unparsedRightOperand = trimmedPredicate.substring(2).trim();
		try {
