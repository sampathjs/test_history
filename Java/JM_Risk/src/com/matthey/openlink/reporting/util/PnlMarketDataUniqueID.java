...
public class PnlMarketDataUniqueID 
{
	...
	public PnlMarketDataUniqueID(int dealNum, int dealLeg, int dealPdc, int dealReset)
	{
		m_dealNum = dealNum;
		m_dealLeg = dealLeg;
		m_dealPdc = dealPdc;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		PnlMarketDataUniqueID other = (PnlMarketDataUniqueID) obj;
