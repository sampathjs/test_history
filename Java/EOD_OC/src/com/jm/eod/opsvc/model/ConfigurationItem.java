...
public enum ConfigurationItem implements ConstRepItem {
	...
	LOG_FILE ("logFile", "EOD.log"),
	LOG_DIRECTORY ("logDir", "%AB_OUTDIR%"),
	EOD_WORKFLOW_NAME ("tpmNameEod", "Global EoD, UK Invoice and Ledgers Processing"),
	VAR_NAME_REPORT_BACK ("varNameReportBack", "IsEODRunning")
	;

	public static final String CONST_REP_CONTEXT="EOD";
	public static final String CONST_REP_SUBCONTEXT="";
