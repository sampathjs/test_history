...
public class EOD_JM_US_MissingResetsAfterFixing implements IScript
{
    public void execute (IContainerContext context) throws OException
	{
		List<Parameters> parameters = new ArrayList<>(0);
		parameters.add(new Parameters(Const.REGION_COL_NAME, COL_TYPE_ENUM.COL_STRING, RegionEnum.USA.description().trim()));
		String regionCode = RegionEnum.USA.description().trim();
