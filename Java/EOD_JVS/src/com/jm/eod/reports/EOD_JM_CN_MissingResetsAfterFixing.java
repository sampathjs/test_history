 ...
 *
 * Report deals with missing resets within the China region after running fixings
 *
 * Revision History:
...
public class EOD_JM_CN_MissingResetsAfterFixing implements IScript {

	public void execute(IContainerContext context) throws OException {

		List<Parameters> parameters = new ArrayList<>(0);
		parameters.add(new Parameters(Const.REGION_COL_NAME, COL_TYPE_ENUM.COL_STRING, RegionEnum.CHINA.description().trim()));
		String regionCode = RegionEnum.CHINA.description().trim();
