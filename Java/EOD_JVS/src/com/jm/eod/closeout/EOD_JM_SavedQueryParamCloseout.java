...
public class EOD_JM_SavedQueryParamCloseout implements IScript {
	...
	public EOD_JM_SavedQueryParamCloseout(){
	...
	public void execute(IContainerContext context) throws OException
	{
		...
		String query_name = "SocGen Nymex Futures";
		/*********************************************************************/
		...
		Table temp;
		int flag=0;
		m_INCStandard.Print(error_log_file, "START", "*** Start of Param Script - EOD_JM_SavedQueryParamCloseout ***");
		...
		if(argt.getColNum( "out_params") <= 0) { // Not Running in Report Manager 
			...
			if(query_id <= 0) {
				...
				if(accessGui != 0){
					...
					m_INCStandard.Print(error_log_file, "END", "*** End of Param Script - EOD_JM_SavedQueryParamCloseout ***\n");
