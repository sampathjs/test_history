...
/*	package standard.report;*/
	...
	public class /*STD_SavedQueryParam*/JM_SavedQueryParam  implements IScript {
		...
		public JM_SavedQueryParam(){
			m_INCStandard = new JVS_INC_Standard();
			query_name = "My Query";
		}
		
		public JM_SavedQueryParam(String queryName){
			m_INCStandard = new JVS_INC_Standard();
		...
		public void execute(IContainerContext context) throws OException
		{
			...
			Table temp;
			int flag=0;
			m_INCStandard.Print(error_log_file, "START", "*** Start of Param Script - " + /*STD_SavedQueryParam */this.getClass().getSimpleName() +" ***");
			...
			if(argt.getColNum( "out_params") <= 0) { // Not Running in Report Manager 
				...
				if(query_id <= 0) {
					...
					if(accessGui != 0){
						...
						m_INCStandard.Print(error_log_file, "END", "*** End of Param Script - " + /*STD_SavedQueryParam*/this.getClass().getSimpleName() +" ***\n");
