...
public class TozPriceCalculator extends AbstractTransactionListener {
	...
	public static final String CONST_REPO_SUBCONTEXT = "TozPriceCalculator"; // sub context 

	/*
	 * (non-Javadoc)
	 * 
	 * @see
	 * com.olf.embedded.trading.AbstractTransactionListener#notify(com.olf.embedded.application.Context, com.olf.openrisk.trading.Transaction)
	 */
	@Override
