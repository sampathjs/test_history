 ...
 */
public class LoadCloseSaveClose implements IScript
{
	ConstRepository repository = null;
	boolean bIgnoreLoadIndexFailed;
	boolean bSaveVolatility;
	...
	{
		// using Mkt Manager date - disfunctional!
		//saveVolaClose (OCalendar.formatJdForDbAccess (OCalendar.today ()));
