...
public class InsertTestValues implements CustomSqlChange {
	...
	private List<SqlStatement> testUserInsert(Database database) {
		...
		String insertTemplate = 
				"INSERT INTO dbo.user_entity (user_id, email, first_name, last_name, role_id, reference_lifecycle_status_id, default_internal_bunit_id, default_internal_portfolio_reference_id, system_name) VALUES (%s, '%s', '%s', '%s', %s, %s, %s, %s, '%s')";
