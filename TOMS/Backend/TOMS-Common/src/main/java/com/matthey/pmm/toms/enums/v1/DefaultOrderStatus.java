...
public enum DefaultOrderStatus {
	...
	LIMIT_ORDER_PART_FILLED_CANCELLED (7, DefaultReference.ORDER_TYPE_LIMIT_ORDER.getEntity(), DefaultReference.ORDER_STATUS_PARTIAL_CANCELLED.getEntity()),
	...
	REFERENCE_ORDER_PART_FILLED (105, DefaultReference.ORDER_TYPE_REFERENCE_ORDER.getEntity(), DefaultReference.ORDER_STATUS_PART_FILLED .getEntity()),
