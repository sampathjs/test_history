...
public enum DefaultReference {
	...
	BUY_SELL_BUY (DefaultReferenceType.BUY_SELL, 15, "Buy", 0, 40000l),
	BUY_SELL_SELL (DefaultReferenceType.BUY_SELL, 16, "Sell", 1, 41000l),
	...
	INDEX_NAME_PX_XAG_CNY (DefaultReferenceType.INDEX_NAME, 49, "PX_XAG.CNY", 1020668, 120000l),
	INDEX_NAME_PX_XAG_EUR (DefaultReferenceType.INDEX_NAME, 50, "PX_XAG.EUR", 1020182, 121000l),
	INDEX_NAME_PX_XAG_GBP (DefaultReferenceType.INDEX_NAME, 51, "PX_XAG.GBP", 1020183, 122000l),
	INDEX_NAME_PX_XAG_USD (DefaultReferenceType.INDEX_NAME, 52, "PX_XAG.USD", 1020019, 123000l),
	INDEX_NAME_PX_XAU_CNY (DefaultReferenceType.INDEX_NAME, 53, "PX_XAU.CNY", 1020669, 124000l),
	INDEX_NAME_PX_XAU_EUR (DefaultReferenceType.INDEX_NAME, 54, "PX_XAU.EUR", 1020176, 122500l),
	INDEX_NAME_PX_XAU_GBP (DefaultReferenceType.INDEX_NAME, 55, "PX_XAU.GBP", 1020184, 122600l),
	INDEX_NAME_PX_XAU_USD (DefaultReferenceType.INDEX_NAME, 56, "PX_XAU.USD", 1020014, 122700l),
	INDEX_NAME_PX_XIR_CNY (DefaultReferenceType.INDEX_NAME, 57, "PX_XIR.CNY", 1020670, 122800l),
	INDEX_NAME_PX_XIR_EUR (DefaultReferenceType.INDEX_NAME, 58, "PX_XIR.EUR", 1020175, 122900l),
	INDEX_NAME_PX_XIR_GBP (DefaultReferenceType.INDEX_NAME, 59, "PX_XIR.GBP", 1020185, 130000l),
	INDEX_NAME_PX_XIR_USD (DefaultReferenceType.INDEX_NAME, 60, "PX_XIR.USD", 1020035, 131000l),
	INDEX_NAME_PX_XOS_CNY (DefaultReferenceType.INDEX_NAME, 61, "PX_XOS.CNY", 1020671, 132000l),
	INDEX_NAME_PX_XOS_EUR (DefaultReferenceType.INDEX_NAME, 62, "PX_XOS.EUR", 1020178, 133000l),
	INDEX_NAME_PX_XOS_GBP (DefaultReferenceType.INDEX_NAME, 63, "PX_XOS.GBP", 1020186, 134000l),
	INDEX_NAME_PX_XOS_USD (DefaultReferenceType.INDEX_NAME, 64, "PX_XOS.USD", 1020038, 135000l),
	INDEX_NAME_PX_XPD_CNY (DefaultReferenceType.INDEX_NAME, 65, "PX_XPD.CNY", 1020672, 136000l),
	INDEX_NAME_PX_XPD_EUR (DefaultReferenceType.INDEX_NAME, 66, "PX_XPD.EUR", 1020174, 137000l),
	INDEX_NAME_PX_XPD_GBP (DefaultReferenceType.INDEX_NAME, 67, "PX_XPD.GBP", 1020187, 138000l),
	INDEX_NAME_PX_XPD_USD (DefaultReferenceType.INDEX_NAME, 68, "PX_XPD.USD", 1020007, 139000l),
	INDEX_NAME_PX_XPT_CNY (DefaultReferenceType.INDEX_NAME, 69, "PX_XPT.CNY", 1020673, 140000l),
	INDEX_NAME_PX_XPT_EUR (DefaultReferenceType.INDEX_NAME, 70, "PX_XPT.EUR", 1020171, 141000l),
	INDEX_NAME_PX_XPT_GBP (DefaultReferenceType.INDEX_NAME, 71, "PX_XPT.GBP", 1020188, 142000l),
	INDEX_NAME_PX_XPT_USD (DefaultReferenceType.INDEX_NAME, 72, "PX_XPT.USD", 1020025, 143000l),
	INDEX_NAME_PX_XRH_CNY (DefaultReferenceType.INDEX_NAME, 73, "PX_XRH.CNY", 1020674, 144000l),
	INDEX_NAME_PX_XRH_EUR (DefaultReferenceType.INDEX_NAME, 74, "PX_XRH.EUR", 1020179, 145000l),
	INDEX_NAME_PX_XRH_GBP (DefaultReferenceType.INDEX_NAME, 75, "PX_XRH.GBP", 1020189, 146000l),
	INDEX_NAME_PX_XRH_USD (DefaultReferenceType.INDEX_NAME, 76, "PX_XRH.USD", 1020076, 147000l),
	INDEX_NAME_PX_XRU_CNY (DefaultReferenceType.INDEX_NAME, 77, "PX_XRU.CNY", 1020675, 148000l),
	INDEX_NAME_PX_XRU_EUR (DefaultReferenceType.INDEX_NAME, 78, "PX_XRU.EUR", 1020180, 149000l),
	INDEX_NAME_PX_XRU_GBP (DefaultReferenceType.INDEX_NAME, 79, "PX_XRU.GBP", 1020190, 150000l),
	INDEX_NAME_PX_XRU_USD (DefaultReferenceType.INDEX_NAME, 80, "PX_XRU.USD", 1020010, 151000l),
	INDEX_NAME_FX_EUR_CHF (DefaultReferenceType.INDEX_NAME, 81, "FX_EUR.CHF", 1020082, 152000l),
	INDEX_NAME_FX_EUR_CNY (DefaultReferenceType.INDEX_NAME, 82, "FX_EUR.CNY", 1020066, 153000l),
	INDEX_NAME_FX_EUR_GBP (DefaultReferenceType.INDEX_NAME, 83, "FX_EUR.GBP", 1020053, 154000l),
	INDEX_NAME_FX_EUR_HKD (DefaultReferenceType.INDEX_NAME, 84, "FX_EUR.HKD", 1020074, 155000l),
	INDEX_NAME_FX_EUR_USD (DefaultReferenceType.INDEX_NAME, 85, "FX_EUR.USD", 1020051, 156000l),
	INDEX_NAME_FX_EUR_ZAR (DefaultReferenceType.INDEX_NAME, 86, "FX_EUR.ZAR", 1020073, 157000l),
	INDEX_NAME_FX_GBP_CHF (DefaultReferenceType.INDEX_NAME, 87, "FX_GBP.CHF", 1020128, 158000l),
	INDEX_NAME_FX_GBP_CNY (DefaultReferenceType.INDEX_NAME, 88, "FX_GBP.CNY", 1020075, 159000l),
	INDEX_NAME_FX_GBP_HKD (DefaultReferenceType.INDEX_NAME, 89, "FX_GBP.HKD", 1020072, 160000l),
	INDEX_NAME_FX_GBP_USD (DefaultReferenceType.INDEX_NAME, 90, "FX_GBP.USD", 1020116, 161000l),
	INDEX_NAME_FX_GBP_ZAR (DefaultReferenceType.INDEX_NAME, 91, "FX_GBP.ZAR", 1020045, 162000l),
	INDEX_NAME_FX_HKD_USD (DefaultReferenceType.INDEX_NAME, 92, "FX_HKD.USD", 1020144, 163000l),
	INDEX_NAME_FX_USD_CHF (DefaultReferenceType.INDEX_NAME, 93, "FX_USD.CHF", 1020083, 164000l),
	INDEX_NAME_FX_USD_CNY (DefaultReferenceType.INDEX_NAME, 94, "FX_USD.CNY", 1020064, 165000l),
	INDEX_NAME_FX_USD_HKD (DefaultReferenceType.INDEX_NAME, 95, "FX_USD.HKD", 1020071, 166000l),
	INDEX_NAME_FX_USD_ZAR (DefaultReferenceType.INDEX_NAME, 96, "FX_USD.ZAR", 1020070, 167000l),
	...
	PRICE_TYPE_SPOT (DefaultReferenceType.PRICE_TYPE, 105, "Spot", 200000l),
	PRICE_TYPE_FORWARD (DefaultReferenceType.PRICE_TYPE, 106, "Forward", 201000l),
	...
	PORTFOLIO_UK_FX (DefaultReferenceType.PORTFOLIO, 118, "UK FX", 20001, 260000l),
	...
	METAL_FORM_INGOT (DefaultReferenceType.METAL_FORM , 164, "Ingot", 1, 310000l),
	METAL_FORM_SPONGE (DefaultReferenceType.METAL_FORM , 165, "Sponge", 3, 311000l),
	METAL_FORM_GRAIN (DefaultReferenceType.METAL_FORM , 166, "Grain", 2, 312000l),
	METAL_FORM_NONE (DefaultReferenceType.METAL_FORM , 167, "None", 0, 313000l),
	...
	REF_SOURCE_LPPM_AM (DefaultReferenceType.REF_SOURCE, 194, "LPPM AM", 20007, 374000l),
	REF_SOURCE_LBMA_PM (DefaultReferenceType.REF_SOURCE, 382, "LBMA PM", 20006, 375000l),
	...
	INDEX_NAME_XAG_CNY (DefaultReferenceType.INDEX_NAME, 340, "XAG/CNY",	1020676, 0l),
	INDEX_NAME_XAG_EUR (DefaultReferenceType.INDEX_NAME, 341, "XAG/EUR",	1020191, 0l),
	INDEX_NAME_XAG_GBP (DefaultReferenceType.INDEX_NAME, 342, "XAG/GBP",	1020198, 0l),
	INDEX_NAME_XAG_USD (DefaultReferenceType.INDEX_NAME, 343, "XAG/USD",	1020056, 0l),
	INDEX_NAME_XAU_CNY (DefaultReferenceType.INDEX_NAME, 344, "XAU/CNY",	1020677, 0l),
	INDEX_NAME_XAU_EUR (DefaultReferenceType.INDEX_NAME, 345, "XAU/EUR",	1020192, 0l),
	INDEX_NAME_XAU_GBP (DefaultReferenceType.INDEX_NAME, 346, "XAU/GBP",	1020199, 0l),
	INDEX_NAME_XAU_USD (DefaultReferenceType.INDEX_NAME, 347, "XAU/USD",	1020049, 0l),
	INDEX_NAME_XIR_CNY (DefaultReferenceType.INDEX_NAME, 348, "XIR/CNY",	1020678, 0l),
	INDEX_NAME_XIR_EUR (DefaultReferenceType.INDEX_NAME, 349, "XIR/EUR",	1020193, 0l),
	INDEX_NAME_XIR_GBP (DefaultReferenceType.INDEX_NAME, 350, "XIR/GBP",	1020200, 0l),
	INDEX_NAME_XIR_USD (DefaultReferenceType.INDEX_NAME, 351, "XIR/USD",	1020069, 0l),
	INDEX_NAME_XOS_CNY (DefaultReferenceType.INDEX_NAME, 353, "XOS/CNY",	1020679, 0l),
	INDEX_NAME_XOS_EUR (DefaultReferenceType.INDEX_NAME, 354, "XOS/EUR",	1020194, 0l),
	INDEX_NAME_XOS_GBP (DefaultReferenceType.INDEX_NAME, 355, "XOS/GBP",	1020201, 0l),
	INDEX_NAME_XOS_USD (DefaultReferenceType.INDEX_NAME, 356, "XOS/USD",	1020058, 0l),
	INDEX_NAME_XPD_CNY (DefaultReferenceType.INDEX_NAME, 357, "XPD/CNY",	1020680, 0l),
	INDEX_NAME_XPD_EUR (DefaultReferenceType.INDEX_NAME, 358, "XPD/EUR",	1020195, 0l),
	INDEX_NAME_XPD_GBP (DefaultReferenceType.INDEX_NAME, 359, "XPD/GBP",	1020202, 0l),
	INDEX_NAME_XPD_USD (DefaultReferenceType.INDEX_NAME, 360, "XPD/USD",	1020061, 0l),
	INDEX_NAME_XPT_CNY (DefaultReferenceType.INDEX_NAME, 362, "XPT/CNY",	1020681, 0l),
	INDEX_NAME_XPT_EUR (DefaultReferenceType.INDEX_NAME, 363, "XPT/EUR",	1020172, 0l),
	INDEX_NAME_XPT_GBP (DefaultReferenceType.INDEX_NAME, 364, "XPT/GBP",	1020203, 0l),
	INDEX_NAME_XPT_USD (DefaultReferenceType.INDEX_NAME, 365, "XPT/USD",	1020065, 0l),
	INDEX_NAME_XRH_CNY (DefaultReferenceType.INDEX_NAME, 367, "XRH/CNY",	1020543, 0l),
	INDEX_NAME_XRH_EUR (DefaultReferenceType.INDEX_NAME, 368, "XRH/EUR",	1020196, 0l),
	INDEX_NAME_XRH_GBP (DefaultReferenceType.INDEX_NAME, 369, "XRH/GBP",	1020204, 0l),
	INDEX_NAME_XRH_USD (DefaultReferenceType.INDEX_NAME, 370, "XRH/USD",	1020077, 0l),
	INDEX_NAME_XRU_CNY (DefaultReferenceType.INDEX_NAME, 372, "XRU/CNY",	1020683, 0l),
	INDEX_NAME_XRU_EUR (DefaultReferenceType.INDEX_NAME, 373, "XRU/EUR",	1020197, 0l),
	INDEX_NAME_XRU_GBP (DefaultReferenceType.INDEX_NAME, 374, "XRU/GBP",	1020205, 0l),
	INDEX_NAME_XRU_USD (DefaultReferenceType.INDEX_NAME, 375, "XRU/USD",	1020060, 0l),
