...
public enum DefaultReference {
	...
	REF_SOURCE_NONE (DefaultReferenceType.REF_SOURCE, 190, "None", 0),
	REF_SOURCE_MANUAL (DefaultReferenceType.REF_SOURCE, 191, "Manual", 33),
	REF_SOURCE_BLOOMBERG (DefaultReferenceType.REF_SOURCE, 192, "BLOOMBERG", 20001),
	REF_SOURCE_LBMA (DefaultReferenceType.REF_SOURCE, 193, "LBMA", 20002),
	REF_SOURCE_LPPM (DefaultReferenceType.REF_SOURCE, 194, "LPPM", 20004),
	REF_SOURCE_LIBOR_BBA (DefaultReferenceType.REF_SOURCE, 195, "LIBOR-BBA", 20005),
	REF_SOURCE_LBMA_PM (DefaultReferenceType.REF_SOURCE, 196, "LBMA PM", 20006),
	REF_SOURCE_LBMA_AM (DefaultReferenceType.REF_SOURCE, 197, "LBMA AM", 20007),
	REF_SOURCE_JM_NY_OPENING (DefaultReferenceType.REF_SOURCE, 198, "JM NY Opening", 20008),
	REF_SOURCE_COMEX (DefaultReferenceType.REF_SOURCE, 199, "COMEX", 20009),
	REF_SOURCE_JM_LONDON_OPENING (DefaultReferenceType.REF_SOURCE, 200, "JM London Opening", 20011),
	REF_SOURCE_JM_HK_OPENING (DefaultReferenceType.REF_SOURCE, 201, "JM HK Opening", 20012 ),
	REF_SOURCE_JM_HK_CLOSING (DefaultReferenceType.REF_SOURCE, 202, "JM HK Closing", 20013),
	REF_SOURCE_ECB (DefaultReferenceType.REF_SOURCE, 203, "ECB", 20014),
	REF_SOURCE_CUSTOM (DefaultReferenceType.REF_SOURCE, 204, "Custom", 20016),
	REF_SOURCE_LME_AM (DefaultReferenceType.REF_SOURCE, 205, "LME AM", 20017),
	REF_SOURCE_LME_PM (DefaultReferenceType.REF_SOURCE, 206, "LME PM", 20018),
	REF_SOURCE_COMDAQ (DefaultReferenceType.REF_SOURCE, 207, "Comdaq", 20019),
	REF_SOURCE_NY_MW_HIGH (DefaultReferenceType.REF_SOURCE, 208, "NY MW High", 20020),
	REF_SOURCE_NY_MW_LOW (DefaultReferenceType.REF_SOURCE, 209, "NY MW Low", 20021),
	REF_SOURCE_LBMA_SILVER (DefaultReferenceType.REF_SOURCE, 210, "LBMA Silver", 20022),
	REF_SOURCE_LME_BASE (DefaultReferenceType.REF_SOURCE, 211, "LME Base", 20023),
	REF_SOURCE_CITIBANK_FORWARD (DefaultReferenceType.REF_SOURCE, 212, "Citibank Forward", 20024),
	REF_SOURCE_PHYSICAL (DefaultReferenceType.REF_SOURCE, 213, "Physical", 20025),
	REF_SOURCE_CITIBANK (DefaultReferenceType.REF_SOURCE, 214, "Citibank 1500", 20026),
	REF_SOURCE_IMPALA_RATE (DefaultReferenceType.REF_SOURCE, 215, "Impala Rate", 20027),
	REF_SOURCE_NY_MW_MID (DefaultReferenceType.REF_SOURCE, 216, "NY MW Mid", 20028),
	REF_SOURCE_FNB (DefaultReferenceType.REF_SOURCE, 217, "FNB", 20029),
	REF_SOURCE_BFIX_1500 (DefaultReferenceType.REF_SOURCE, 218, "BFIX 1500", 20030),
	REF_SOURCE_BFIX_FORWARD (DefaultReferenceType.REF_SOURCE, 219, "BFIX Forward", 20031),
	REF_SOURCE_BFIX_1400 (DefaultReferenceType.REF_SOURCE, 220, "BFIX 1400", 20032),
	REF_SOURCE_BOC (DefaultReferenceType.REF_SOURCE, 221, "BOC", 20033),
	REF_SOURCE_JMLO_BFIX_1400 (DefaultReferenceType.REF_SOURCE, 222, "JMLO BFIX 1400", 20034),
