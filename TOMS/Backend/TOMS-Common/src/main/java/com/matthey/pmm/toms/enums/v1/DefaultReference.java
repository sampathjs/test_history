...
public enum DefaultReference {
	...
	CONTRACT_TYPE_AVERAGE (DefaultReferenceType.CONTRACT_TYPE , 224, "Average", 410000l),
	CONTRACT_TYPE_FIXING (DefaultReferenceType.CONTRACT_TYPE , 225, "Fixing", 411000l),
	REFERENCE_ORDER_LEG_TRANSITION (DefaultReferenceType.PROCESS_TRANSITION_TYPE, 226, "Transition for Reference Orders Legs", 233000l),
	;
