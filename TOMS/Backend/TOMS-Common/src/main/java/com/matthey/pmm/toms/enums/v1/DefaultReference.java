...
public enum DefaultReference {
	...
	CONTRACT_TYPE_LIMIT_RELATIVE (DefaultReferenceType.CONTRACT_TYPE_REFERENCE_ORDER , 226, "Relative", 420000l),
	CONTRACT_TYPE_LIMIT_FIXED (DefaultReferenceType.CONTRACT_TYPE_REFERENCE_ORDER , 227, "Fixed", 421000l),
