...
public interface ReferenceOrderRepository  extends PagingAndSortingRepository<ReferenceOrder, OrderVersionId>, JpaSpecificationExecutor<ReferenceOrder> {
   ...
   @Query("SELECT o FROM ReferenceOrder o WHERE o.orderId = :orderId AND o.version = (SELECT MAX(o2.version) FROM ReferenceOrder o2 WHERE o2.orderId = :orderId)") 
  ...
  // https://docs.spring.io/spring-data/rest/docs/2.0.0.M1/reference/html/paging-chapter.html
   ...
   @Query("SELECT o FROM ReferenceOrder o WHERE o.version = (SELECT MAX(o2.version) FROM ReferenceOrder o2 WHERE o2.orderId = o.orderId)") 
