...
@SpringBootApplication(scanBasePackages = "com.matthey.pmm.gmm")
@EnableScheduling
@EnableSwagger2
public class GroupMetalManagementService {
    
    public static void main(String[] args) {
        SpringApplication.run(GroupMetalManagementService.class, args);
    }
