--tabletitle MetalUtilisationStatementsU "Metal Utilisation Statements from user table"
...
SELECT 
   ...
   , (CASE 
          WHEN (SELECT DATA_TYPE 
                      ...
                      WHERE 
                                    TABLE_NAME = 'USER_jm_metal_rentals_run_data'
                           AND  COLUMN_NAME = 'account_id')                                         = 'varchar' THEN rd.account_id
          ELSE rd.account_name            
     END) account_id 
  ...
  ,rd.phone2
  ,rd.description
FROM USER_jm_metal_rentals_run_data rd
