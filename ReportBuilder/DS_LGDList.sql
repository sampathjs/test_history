SELECT DISTINCT csh.ins_num, csh.param_seq_num, csh.schedule_id, batch2.batch_num, batch2.form_id,
	...
	(SELECT ',' + dti.info_value FROM delivery_ticket_info dti 
	...
	JOIN ab_tran ab ON ab.ins_num = csh.ins_num 
	AND ab.current_flag = 1 AND ab.ins_type = 48010 AND ab.buy_sell = 1
