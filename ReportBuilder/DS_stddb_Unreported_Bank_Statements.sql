...
select exp_account_id 
from input_exp_account 
where exp_account_id not in (
	select account_id from input_file_ref where  official_system_date between '$$START_DATE$$' and  '$$END_DATE$$' and file_status_id =3
)