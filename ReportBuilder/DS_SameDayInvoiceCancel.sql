...
JOIN stldoc_info_h sti ON sti.document_num=sh.document_num AND sti.stldoc_hdr_hist_id = sh.stldoc_hdr_hist_id
JOIN stldoc_info_h sti1 ON sti1.document_num=sh.document_num AND sti.stldoc_hdr_hist_id = sh.stldoc_hdr_hist_id
