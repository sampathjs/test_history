USE [DBA]
GO
/****** Object:  StoredProcedure [AppSupport].[CheckNode9DateCorrectness]    Script Date: 28/11/2019 14:09:38 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROC [AppSupport].[CheckNode9DateCorrectness] (@debug TINYINT = 0,@email_address  varchar(1000) = 'charles.badcock@matthey.com')  
-------------------------------------------------------  
...
SET @sql_stmt = 'SELECT sm.service_name, sd.processing_date sys_process_date, sm.curr_date server_date, smh_prior.prior_last_update prior_last_update,   
    ...
    INTO ##CheckNode9DateCorrectness 
